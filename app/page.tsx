    ...
    <main className="elc-site">
      ...
      <section id="about" className="elc-intro" aria-labelledby="intro-title">
        ...
        <div className="elc-intro-content">
          <p className="elc-intro-text" data-intro-type>
          ...
          <div className="elc-intro-visual" aria-hidden="true" data-intro-visual>
            <Image
              src="/images/Frame-7-p-500.png"
              alt=""
              width={500}
              height={500}
              sizes="(max-width: 768px) 44vw, 430px"
              priority={false}
            />
          </div>
        </div>
      ...
      <section className="elc-image-expand" aria-hidden="true" data-image-expand-section>
        <div className="elc-image-expand-stage">
          <div className="elc-image-expand-card" data-image-expand-card>
            <Image
              src="/images/Building-Wall-Mockup-p-1080.png"
              alt=""
              width={1080}
              height={810}
              sizes="100vw"
